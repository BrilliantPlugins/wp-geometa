...
Tags: GIS, spatial, metadata, geography, mapping, postmeta, meta, search
...
Install this plugin the usual WordPress way. 

1. Upload the plugin files to the
`/wp-content/plugins/wp-geometa` directory, or install the
...
= Usage: Writing and Reading Data =
 ...
 * Prepping for WordPress plugin directory submission.
